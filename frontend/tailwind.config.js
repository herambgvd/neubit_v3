...
module.exports = {
  ...
  mode: "jit",
  darkMode: "class",
  // Colours picked at runtime via `text-${confColor(...)}-500` etc. can't be seen
  // by Tailwind's static scan, so pin the full matrix used by the scenario UI.
  safelist: [
    { pattern: /(text|bg|border|ring)-(green|amber|red|slate|blue|indigo)-(400|500|600)/ },
  ],
  theme: {
    container: {
      center: true,
    ...
    extend: {
      colors: {
        ...
        black: {
          DEFAULT: "#000000", // so text-black / bg-black resolve to true black
          50: "#F9FAFB",
          100: "#F4F5F7",
          200: "#E5E7EB",
          300: "#D2D6DC",
