          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <button
                ...
                className={`text-[10px] rounded-full px-1.5 py-0.5 font-medium transition hover:opacity-80 disabled:opacity-50 ${enabled ? "bg-green-500/10 text-green-500" : "bg-[rgba(96,165,250,.1)] text-nb-faint"}`}
              >
