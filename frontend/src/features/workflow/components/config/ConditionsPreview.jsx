        ...
        <div className="grid grid-cols-1 gap-3 border-t border-nb-line p-3 md:grid-cols-2">
          <div>
            ...
            <textarea
              ...
              spellCheck={false}
              className="mt-1 h-44 w-full rounded-lg border border-nb-line bg-transparent px-2.5 py-2 text-xs font-mono text-nb-ink outline-hidden focus:border-nb-teal"
            />
