...
export function MfaForm({ code, setCode, error, busy, onSubmit, onBack }) {
  return (
    <form onSubmit={onSubmit} className="space-y-5" noValidate>
      <div className="flex items-start gap-3 rounded-lg border border-emerald-400/20 bg-emerald-500/5 px-3 py-2.5">
        <Icon icon="heroicons-outline:key" className="mt-0.5 h-4 w-4 shrink-0 text-emerald-400" />
