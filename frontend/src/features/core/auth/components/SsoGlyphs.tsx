...
export function GoogleGlyph(props: GlyphProps) {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" style={{ fill: "none", stroke: "none" }} {...props}>
      ...
      <path fill="#34A853" d="M12 24c3.24 0 5.95-1.08 7.93-2.91l-3.87-3c-1.07.72-2.45 1.15-4.06 1.15-3.12 0-5.77-2.11-6.71-4.96H1.29v3.1A11.99 11.99 0 0 0 12 24z" />
      ...
      <path fill="#EA4335" d="M12 4.77c1.76 0 3.34.6 4.58 1.79l3.44-3.44C17.94 1.19 15.23 0 12 0 7.31 0 3.26 2.69 1.29 6.62l4 3.1C6.23 6.88 8.88 4.77 12 4.77z" />
    </svg>
  );
}
...
export function MicrosoftGlyph(props: GlyphProps) {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" style={{ fill: "none", stroke: "none" }} {...props}>
      ...
      <rect x="12.7" y="1" width="10.3" height="10.3" fill="#7FBA00" />
      <rect x="1" y="12.7" width="10.3" height="10.3" fill="#00A4EF" />
      <rect x="12.7" y="12.7" width="10.3" height="10.3" fill="#FFB900" />
    </svg>
  );
}
...
export function EnterpriseSsoGlyph(props: GlyphProps) {
  return (
    <svg viewBox="0 0 24 24" width="16" height="16" style={{ fill: "none", stroke: "#c4b5fd", strokeWidth: 1.7, strokeLinecap: "round" }} {...props}>
      ...
      <path d="M11 11l8-8M16 6l2.5 2.5M13 9l2 2" />
    </svg>
  );
}
