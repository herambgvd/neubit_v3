...
export default function NeubitAuthShell({ children }) {
  return (
    <div
...
/* ------------------------------------------------------------------ */
export function NbLabel({ children }) {
  return (
...
export function NbSubmit({ children, loading, disabled }) {
  return (
    <button
      type="submit"
...
export function NbError({ children }) {
  if (!children) return null;
  return (
    <div
      role="alert"
