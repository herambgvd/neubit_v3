...
export default function AccessGroupModal({ instanceId, group, onClose, onSuccess }: any) {
  const isEdit = !!group;
  const qc = useQueryClient();

  const groupQ = useQuery<any>({
  ...
  const idSet = useMemo(() => new Set<any>(doorIds), [doorIds]);
