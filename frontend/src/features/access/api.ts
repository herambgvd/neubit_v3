...
export const gates = {
  // ── Instances ─────────────────────────────────────────────────
  instances: {
    list: (params: any = {}) => unwrap(api.get(`${BASE}/instances${qs(params)}`)),
  ...
  // ── Doors (local) ─────────────────────────────────────────────
  doors: {
    list: (params: any = {}) => unwrap(api.get(`${BASE}/doors${qs(params)}`)),
  ...
  hardware: {
    list: (instanceId, set, params: any = {}) =>
  ...
  scheduled: {
    list: (instanceId, kind, params: any = {}) =>
