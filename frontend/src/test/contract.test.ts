...
const MAPPING: Record<string, ModelEntry & { subset?: string }> = {
  ...
  "features/workflow/types.ts:CreateInstanceRequest": { src: "WORKFLOW", file: "instances/schemas.py", model: "CreateInstanceRequest" },
  "features/workflow/types.ts:CreateSopRequest": { src: "WORKFLOW", file: "sops/schemas.py", model: "CreateSopRequest" },
  "features/workflow/types.ts:InstallStartersResponse": { src: "WORKFLOW", file: "sops/schemas.py", model: "InstallStartersResponse" },
