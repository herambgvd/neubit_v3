...
const MAPPING: Record<string, ModelEntry & { subset?: string }> = {
  ...
  "lib/types.ts:NvrPublic": { src: "VISION", file: "nvr/schemas.py", model: "NvrPublic" },
  ...
  "features/vms/types.ts:BulkAddBody": { src: "VISION", file: "cameras/schemas.py", model: "BulkAddBody" },
  "features/vms/types.ts:BulkAddChannel": { src: "VISION", file: "cameras/schemas.py", model: "BulkAddChannel" },
  "features/vms/types.ts:BulkOpItem": { src: "VISION", file: "devicemgmt/schemas.py", model: "BulkOpItem" },
  "features/vms/types.ts:BulkOpResult": { src: "VISION", file: "devicemgmt/schemas.py", model: "BulkOpResult" },
  ...
  "features/vms/types.ts:ChannelPublic": { src: "VISION", file: "cameras/schemas.py", model: "ChannelPublic" },
  ...
  "features/vms/types.ts:DeviceInfoPublic": { src: "VISION", file: "devicemgmt/schemas.py", model: "DeviceInfoPublic" },
  "features/vms/types.ts:DiscoverBody": { src: "VISION", file: "cameras/schemas.py", model: "DiscoverBody" },
  "features/vms/types.ts:DiscoveredPublic": { src: "VISION", file: "cameras/schemas.py", model: "DiscoveredPublic" },
  "features/vms/types.ts:EncoderBody": { src: "VISION", file: "cameras/schemas.py", model: "EncoderBody" },
  ...
  "features/vms/types.ts:ExportJobPublic": { src: "VISION", file: "export/schemas.py", model: "ExportJobPublic" },
  "features/vms/types.ts:ExportStartBody": { src: "VISION", file: "export/schemas.py", model: "ExportStartBody" },
  "features/vms/types.ts:ExportVerifyResult": { src: "VISION", file: "export/schemas.py", model: "ExportVerifyResult" },
  "features/vms/types.ts:FleetOpPublic": { src: "VISION", file: "devicemgmt/schemas.py", model: "FleetOpPublic" },
  ...
  "features/vms/types.ts:MapChannelItem": { src: "VISION", file: "nvr/schemas.py", model: "MapChannelItem" },
  "features/vms/types.ts:MapChannelsResult": { src: "VISION", file: "nvr/schemas.py", model: "MapChannelsResult" },
  ...
  "features/vms/types.ts:MotionHit": { src: "VISION", file: "motion_search/schemas.py", model: "MotionHit" },
  "features/vms/types.ts:MotionRegion": { src: "VISION", file: "motion_search/schemas.py", model: "Region" },
  "features/vms/types.ts:MotionSearchJobPublic": { src: "VISION", file: "motion_search/schemas.py", model: "MotionSearchJobPublic" },
  "features/vms/types.ts:MotionSearchStartBody": { src: "VISION", file: "motion_search/schemas.py", model: "MotionSearchStartBody" },
  "features/vms/types.ts:NodesRollup": { src: "VISION", file: "dashboard/schemas.py", model: "NodesRollup" },
  "features/vms/types.ts:NvrCreate": { src: "VISION", file: "nvr/schemas.py", model: "NvrCreate" },
  "features/vms/types.ts:NvrHealthResponse": { src: "VISION", file: "nvr/schemas.py", model: "NvrHealthResponse" },
  "features/vms/types.ts:NvrPlaybackSession": { src: "VISION", file: "nvr/schemas.py", model: "NvrPlaybackSession" },
  "features/vms/types.ts:NvrRecordingRange": { src: "VISION", file: "nvr/schemas.py", model: "NvrRecordingRange" },
  "features/vms/types.ts:NvrRecordingsResponse": { src: "VISION", file: "nvr/schemas.py", model: "NvrRecordingsResponse" },
  ...
  "features/vms/types.ts:PatrolPublic": { src: "VISION", file: "ptz/schemas.py", model: "PatrolPublic" },
  "features/vms/types.ts:PatrolStop": { src: "VISION", file: "ptz/schemas.py", model: "PatrolStop" },
  ...
  "features/vms/types.ts:PresetPublic": { src: "VISION", file: "ptz/schemas.py", model: "PresetPublic" },
  "features/vms/types.ts:ProbeResponse": { src: "VISION", file: "cameras/schemas.py", model: "ProbeResponse" },
  "features/vms/types.ts:PtzBody": { src: "VISION", file: "cameras/schemas.py", model: "PtzBody" },
  "features/vms/types.ts:PtzMoveBody": { src: "VISION", file: "ptz/schemas.py", model: "PtzMoveBody" },
  "features/vms/types.ts:PtzResult": { src: "VISION", file: "ptz/schemas.py", model: "PtzResult" },
  ...
  "features/vms/types.ts:StreamPolicyResult": { src: "VISION", file: "cameras/schemas.py", model: "StreamPolicyResult" },
  "features/vms/types.ts:TalkSessionPublic": { src: "VISION", file: "audio/schemas.py", model: "TalkSessionPublic" },
  ...
  "features/vms/types.ts:UserAddBody": { src: "VISION", file: "devicemgmt/schemas.py", model: "UserAddBody" },
...
const PASSTHROUGH: Record<string, string> = {
  ...
  "features/vms/types.ts:PrivacyMasksResponse": "built by the camera service from the driver's reply",
  "features/vms/types.ts:MotionZonesResponse": "built by the camera service from the driver's reply",
