...
export function ConsolePage({ className = "", children }) {
  return (
    <div
...
export function ConsoleScroll({ className = "", children }) {
...
export function ConsoleGrid({ cols = "lg:grid-cols-[300px_1fr]", className = "", children }) {
  return (
...
export function ConsolePanel({ className = "", children }) {
...
export function PanelHeader({ icon, title, count, actions, children }) {
  return (
...
export function PanelCounts({ items = [] }) {
  return (
...
export function PanelSearch({ value, onChange, placeholder = "Search…" }) {
  return (
...
export function PanelList({ loading, error, empty, emptyText = "Nothing here yet", children }) {
  return (
...
export function CreateButton({ label, onClick, disabled, className = "" }) {
  return (
    <button
      type="button"
      onClick={onClick}
...
export function ViewActions({ className = "", children }) {
...
export function PaneForm({ title, subtitle, action, onSubmit, footer, className = "", children }) {
  return (
...
export function SectionHead({ icon, title, desc, action, className = "" }) {
  return (
...
export function EmptyPane({ icon = "heroicons-outline:cursor-arrow-rays", title, subtitle }) {
  return (
...
export function InfoCell({ label, value, mono = false, title }) {
  return (
